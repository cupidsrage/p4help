...
# Observed: "Well, just as promised, here is your reward..."
# This fires at the trading post when you turn in a finished quest.
COMPLETE_MARKERS = ("just as promised", "here is your reward",
                    # keep the guesses as fallbacks in case wording varies
                    "quest complete", "you have completed", "quest fulfilled")
